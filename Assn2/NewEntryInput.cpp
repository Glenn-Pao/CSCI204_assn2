...
///summary
///
/// The definitions provided by NewEntryInput.h are further elaborated here
/// The main function to look at will be RegisterNewItem() for the program flow and CheckInput() for the input flow
///
///end summary
...
NewEntryInput::NewEntryInput()
{
	...
	for(int i = 0; i <= maxInputCount; i++)
	{
		...
		case 5:
			...
			break;
		case 6:
			newInputPrompts[i] = "Input the Plasma Density of Solar System  : ";
			break;
		}
	}
}
